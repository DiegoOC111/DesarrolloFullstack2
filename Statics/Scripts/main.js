...
document.querySelectorAll("#categoriasDropdown .dropdown-item").forEach(item => {
  item.addEventListener("click", (e) => {
    e.preventDefault();
    const categoria = item.innerText; 
    document.getElementById("dropdownMenuButton1").innerText = categoria;
...
<footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
  <div class="container d-flex justify-content-between align-items-center">
    <div class="d-flex align-items-center">
      ...
      <span class="text-white">© 2025 Carlos y Diego</span>
    </div>
...
<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light shadow-sm">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <img src="https://github.com/DiegoOC111/DesarrolloFullstack2/blob/Carlos/Statics/Images/logo_pagina.png?raw=true" width="80" height="60" alt="Logo de la tienda">
            </a>
    ...
    if (page === "Productos_cartas") {
        // Manejo de productos y dropdown solo en la página de productos
        document.querySelectorAll("#categoriasDropdown .dropdown-item").forEach(item => {
            item.addEventListener("click", (e) => {
                e.preventDefault();
                const categoria = item.innerText;
